...
void Level1::onStart()
{
	...
	levelFactory.buildBox(this, 2000, glm::vec3(-100, 20, 0), glm::vec3(0, 0, 0), glm::vec3(60, 60, 1));
	levelFactory.buildBox(this, 2000, glm::vec3(100, 20, 0), glm::vec3(0, 0, 0), glm::vec3(60, 60, 1));
	levelFactory.buildBox(this, 600, glm::vec3(0, 200, 0), glm::vec3(0, 0, 0), glm::vec3(300, 20, 1));
